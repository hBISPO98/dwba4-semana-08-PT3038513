...
const alunos = [
    new Aluno("Ana", "Rodrigues", 10, 7.5),
    new Aluno("Bruno", "Madrigal", 8, 10),
    new Aluno("Maurício", "Meirelles", 3, 6),
    new Aluno("Cecília", "Hernandes", 10, 9.2),
    new Aluno("Felipe", "Rosa", 4, 3)
];
...
// Executa a função para mostrar os dados
